var LoginManager = function(inremoteurl) {
    ...
    function executeAJAX(amethod) {
      ...
      function getAuthenticationCookie(extended, formdatain) {
        function getFormIn() {
          ...
          const formData = getFormIn() //getForms("", extended)
            try {
...
//          xhr.setRequestHeader('Content-Type', 'application/json');
              ...
              return {
                ...
                onLoad: function () {
                    if (xhr.status === 200) {
                        ...
                        console.log("new response=[" + JSON.stringify(response, null, 2) + "] status=[" + xhr.status + "]")
                      try {
    ...
    return {
        ...
        getAuthenticationCookie: function (extended, formdatain) {
            getAuthenticationCookie(extended, formdatain)
        },
